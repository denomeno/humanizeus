...
def description_of_mission():
    ...
    <u><b>Mission:</b></u> HumanizeUs's mission is to provide a technical solution to improve access to essential home items for persons that are entering stable housing in our communities.
    <br>
    <br>
    <u><b>Vision:</b></u> We envision a world where all of our neighbors support each other to have a healthy and sustainable home.
    <br>
    <br>
    <b>HumanizeUs</b> is a non-profit dedicated to fighting homelessness by connecting the community through enabling people to donate directly to those in their local community that are in need. We mobilize resources via geographical information systems. Our online platform changes the traditional model of donating to organizations by centralizing the needs of organizations working in the field and the resources of the community to systematically deliver newly housed people with essential living items.
