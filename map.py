...
def display_map():
    ...
    <div class="left">
        <h3>Resource Map</h3>
        <iframe src="map_main.html" height="600" width="8000" align="left">
        </iframe>
    </div>
    ''')
...
def display_list_of_organizations():
    ...
    <div class="left">
        ...
        <p><iframe src="organization_list_frame.py" style = "width: 650px; height: 600px;" align="right" scrolling="yes">
        </p></iframe>
        <br>
    </div>
    ''')
