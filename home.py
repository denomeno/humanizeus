...
def home_page_display():
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
      <button type="button" class="btn btn-group-lg btn-secondary"><a href='/humanizeus/add_need.py'><b>I need support</b></a></button>
      <button type="button" class="btn btn-group-lg btn-secondary"><a href='/humanizeus/add_support.py'><b>I want to donate</b></a></button>
      <button type="button" class="btn btn-group-lg btn-secondary"><a href='/humanizeus/for_organizations.py'><b>I am an organization</b></a></button>
    </div>
    <br>
    <br>
