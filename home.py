...
def home_page_display():
    ...
    <button type="button" style="height:150px;width:250px" align="left"><a href='/humanizeus/add_need.py'><b>I need support</b></a></button>
    <button type="button" style="height:150px;width:250px" align="center"><a href='/humanizeus/add_support.py'><b>I want to donate</b></a></button>
    <button type="button" style="height:150px;width:250px" align="right"><a href='/humanizeus/for_organizations.py'><b>I am an organization</b></a></button>
